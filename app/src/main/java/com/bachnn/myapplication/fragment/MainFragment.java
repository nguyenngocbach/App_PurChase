...
public class MainFragment extends Fragment implements ItemListener, IAllItemListener {
    ...
    private void initData() {
        ...
        mItems.add(new Item("124","Áo Đông","Quần áo ok",
                "https://1.bp.blogspot.com/-hMy1dxmbeCk/UTQG9Gbx1EI/AAAAAAAAHsY/vApdBWaPaYo/s1600/Ngoc+Trinh1-1.jpg","100000","20%",false,0));
        mItems.add(new Item("125","Áo Đông","Quần áo ok",
                "https://tse1.mm.bing.net/th?id=OIP.MVs_p_pgwOCZ2ywLduqxjAHaGe&pid=Api&P=0&w=198&h=174","100000","20%",false,0));
        ...
        mItems.add(new Item("127","Áo Đông","Quần áo ok",
                "https://s-media-cache-ak0.pinimg.com/736x/a5/b9/6a/a5b96a54412532d1cbb79bcf4670f37b.jpg","100000","20%",false,0));
        mItems.add(new Item("128","Áo Đông","Quần áo ok",
                "https://eceleb-gossip.com/wp-content/uploads/2019/06/Ngoc-Trinh-net-worth.jpg","100000","20%",false,0));
        mItems.add(new Item("129","Áo Đông","Quần áo ok",
                "https://hotgirlvietdepnhat.files.wordpress.com/2013/07/hinh-anh-ngoc-trinh20.jpg?w=604","100000","20%",false,0));
        ...
        mItems.add(new Item("132","Áo Đông","Quần áo ok",
                "https://3.bp.blogspot.com/-Wy70krMpmgo/US2kgr5P_0I/AAAAAAAAG-U/qweNyIqmiiY/s1600/Ngoc+Trinh1-1.jpg","100000","20%",false,0));
        ...
        mItems.add(new Item("134","Áo Đông","Quần áo ok",
                "https://2.bp.blogspot.com/-zwRFdNTTgIA/UTQHsZs8UsI/AAAAAAAAHtQ/4MANWvTtNQQ/s1600/Ngoc+Trinh2-3.jpg","100000","20%",false,0));
        mItems.add(new Item("135","Áo Đông","Quần áo ok",
                "http://4.bp.blogspot.com/-_FwF_YFT8AM/Ubfo8bMKrSI/AAAAAAAAKjo/mp4GzlolBvk/s1600/Ngoc+Trinh1-8.jpg","100000","20%",false,0));
        mItems.add(new Item("136","Áo Đông","Quần áo ok",
                "http://iv1.lisimg.com/image/6656173/500full-ngoc-trinh.jpg","100000","20%",false,0));
    }
